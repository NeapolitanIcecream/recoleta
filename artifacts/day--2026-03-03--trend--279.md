...
#### Representative papers
- [His2Trans: A Skeleton First Framework for Self Evolving C to Rust Translation with Historical Retrieval](http://arxiv.org/abs/2603.02617v1) — Shengbo Wang; Mingwei Liu; Guangsheng Ou; Yuwen Chen; Zike Li; Yanlin Wang; …
...
- [RippleGUItester: Change-Aware Exploratory Testing](http://arxiv.org/abs/2603.03121v1) — Yanqi Su; Michael Pradel; Chunyang Chen
...
#### Representative papers
- [Review Beats Planning: Dual-Model Interaction Patterns for Code Synthesis](http://arxiv.org/abs/2603.03406v1) — Jan Miller
...
#### Representative papers
- [Closing the Loop – Optimizing the Agentic SDLC](https://medium.com/@btraut/closing-the-loop-3286bb886605) — btraut
- [The missing piece for AI coding agents](https://www.buildbuddy.io/blog/remote-bazel-with-agents/) — jshchnz
- [Intent-Based Access Control (IBAC) – FGA for AI Agent Permissions](https://ibac.dev) — ERROR_0x06
