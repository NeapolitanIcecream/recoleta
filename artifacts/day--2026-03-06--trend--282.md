...
- [ReflexiCoder: Teaching Large Language Models to Self-Reflect on Generated Code and Self-Correct It via Reinforcement Learning](http://arxiv.org/abs/2603.05863v1) — Juyong Jiang; Jiasi Shen; Sunghun Kim; Kang Min Yoo; Jeonghoon Kim; Sungju Kim
...
#### Representative papers
- [Balancing Latency and Accuracy of Code Completion via Local-Cloud Model Cascading](http://arxiv.org/abs/2603.05974v2) — Hanzhen Lu; Lishui Fan; Jiachi Chen; Qiuyuan Chen; Zhao Wei; Zhongxin Liu
- [A Scalable Benchmark for Repository-Oriented Long-Horizon Conversational Context Management](http://arxiv.org/abs/2603.06358v1) — Yang Liu; Li Zhang; Fang Liu; Ping Lin; Xinyi Li
...
#### Representative papers
- [Show HN: OpenGuard](https://openguard.sh) — everlier
...
- [Patch Validation in Automated Vulnerability Repair](http://arxiv.org/abs/2603.06858v1) — Zheng Yu; Wenxuan Shi; Xinqian Sun; Zheyun Feng; Meng Xu; Xinyu Xing
