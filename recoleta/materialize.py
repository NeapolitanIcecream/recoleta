...
from recoleta import publish as publish_module
from recoleta import site as site_module
...
export_trend_note_pdf_debug_bundle = publish_module.export_trend_note_pdf_debug_bundle
render_trend_note_pdf_result = publish_module.render_trend_note_pdf_result
export_trend_static_site = site_module.export_trend_static_site
...
def _materialize_localized_outputs(
    ...
    **legacy_kwargs: Any,
    ...
    from recoleta.materialize_runtime import (
        coerce_localized_outputs_request,
        materialize_localized_outputs,
    )

    normalized_request = coerce_localized_outputs_request(
        request=request,
        legacy_kwargs=legacy_kwargs,
    )
    materialize_localized_outputs(request=normalized_request)
...
def _materialize_outputs_for_target(
    ...
    **legacy_kwargs: Any,
    ...
    from recoleta.materialize_runtime import (
        coerce_target_outputs_request,
        materialize_outputs_for_target,
    )

    normalized_request = coerce_target_outputs_request(
        request=request,
        legacy_kwargs=legacy_kwargs,
    )
    return cast(
...
def materialize_outputs(
    ...
    **legacy_kwargs: Any,
    ...
    from recoleta.materialize_runtime import coerce_outputs_request, materialize_outputs

    normalized_request = coerce_outputs_request(
        request=request,
        legacy_kwargs=legacy_kwargs,
    )
    return cast(
