...
EMAIL_RENDERER_VERSION = "trend-email-v7"
...
def _render_html_email(*, bundle: _TrendEmailBundle) -> str:
    ...
    return (
        ...
        ".email-title-cell{padding-bottom:22px!important}"
        ".email-title-spacer{height:22px!important;line-height:22px!important}"
        ".email-title{font-size:29px!important;line-height:37px!important}"
        "}"
        "</style>"
        "</head>"
        ...
        f"<tr><td class='email-title-cell' bgcolor='{_EMAIL_COLOR_PAPER}' style='padding:18px 0 24px;background:{_EMAIL_COLOR_PAPER};border-bottom:1px solid {_EMAIL_COLOR_LINE_STRONG}'>"
