...
def run_translate(
    ...
    granularity: str | None = typer.Option(
        None,
        "--granularity",
        help="Select trend and idea granularity: day, week, or month. This is not a date filter; use --date or --period-start/--period-end to bound history.",
    ),
    date: str | None = typer.Option(
        None,
        "--date",
        help="Anchor date for a bounded UTC translation window (YYYY-MM-DD or YYYYMMDD). Uses --granularity to choose day, week, or month bounds.",
    ),
    period_start: str | None = typer.Option(
        None,
        "--period-start",
        help="Inclusive UTC window start as an ISO date or datetime.",
    ),
    period_end: str | None = typer.Option(
        None,
        "--period-end",
        help="Exclusive UTC window end as an ISO date or datetime.",
    ),
    ...
    all_history: bool = typer.Option(
        False,
        "--all-history",
        help="Allow an unbounded historical translation scan. Required with --force when no date or period window is provided.",
    ),
