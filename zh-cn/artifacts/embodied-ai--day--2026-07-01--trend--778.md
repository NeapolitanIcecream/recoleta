...
- [Finding a Needle in the Haystack: Querying Physical AI Data with Daft](../Inbox/2026-07-01--querying-physical-ai-data-with-daft.md): Daft 摘要描述了使用文本嵌入和手部姿态几何进行逐帧 EgoDex 检索。
