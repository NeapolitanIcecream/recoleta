...
- 论文强调了 RoboCasa 长时程任务上的较大提升：**CanToDrawerClose +16.0**、**MilkToMicrowaveClose +24.0** 和 **TrayToPot +18.0**，均高于此前最佳结果。
- 在 RoboTwin 2.0 上对 EgoLive 的消融显示，**JDAgibot + full EgoLive** 的成功率为 **87.42%**，相比之下，无预训练为 **81.64%**，仅用 JDAgibot 为 **77.62%**，**JDAgibot + 10% EgoLive** 为 **81.40%**。
