...
#### Evidence
- [Show HN: Peek-CLI: let coding agents see your browser](../Inbox/2026-06-27--show-hn-peek-cli-let-coding-agents-see-your-browser.md): 摘要描述了 peek-cli 的只读截图模型、CLI 流程、支持的代理以及安全边界。
