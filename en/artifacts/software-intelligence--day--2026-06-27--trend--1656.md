...
#### Evidence
- [Show HN: Peek-CLI: let coding agents see your browser](../Inbox/2026-06-27--show-hn-peek-cli-let-coding-agents-see-your-browser.md): Summary describes peek-cli’s read-only screenshot model, CLI flow, supported agents, and safety boundary.
