...
#### Evidence
- [RynnWorld-4D: 4D Embodied World Models for Robotic Manipulation](../Inbox/2026-07-07--rynnworld-4d-4d-embodied-world-models-for-robotic-manipulation.md): Summarizes RGB-depth-flow prediction, Rynn4DDataset scale, and policy latency.
- [RynnWorld-Teleop: An Action-Conditioned World Model for Digital Teleoperation](../Inbox/2026-07-07--rynnworld-teleop-an-action-conditioned-world-model-for-digital-teleoperation.md): Describes action-conditioned digital teleoperation, 40+ FPS generation, and 54-D action labels.
...
#### Evidence
- [Lift3D-VLA: Lifting VLA Models to 3D Geometry and Dynamics-Aware Manipulation](../Inbox/2026-07-07--lift3d-vla-lifting-vla-models-to-3d-geometry-and-dynamics-aware-manipulation.md): Gives the point-cloud method, training setup, and benchmark deltas.
...
#### Evidence
- [Training-Free Acceleration for Vision-Language-Action Models with Action Caching and Refinement](../Inbox/2026-07-07--training-free-acceleration-for-vision-language-action-models-with-action-caching-and-refinement.md): Reports ActionCache mechanism, latency, and success-rate comparisons.
- [SIEVE: Structure-Aware Data Selection for Imitation Learning with VLA Models](../Inbox/2026-07-07--sieve-structure-aware-data-selection-for-imitation-learning-with-vla-models.md): Reports SIEVE selection method and Bridge-V2 success results.
...
#### Evidence
- [Diagnosing Semantic Handoff Failures in Agent-Orchestrated Vision-Language-Action Skill Composition](../Inbox/2026-07-07--diagnosing-semantic-handoff-failures-in-agent-orchestrated-vision-language-action-skill-composition.md): Details semantic handoff failures, isolated skill scores, rollout progress, and failure categories.
- [LAMP: Latent Motion Prior-Guided Real-World Learning for Dexterous Hand Manipulation](../Inbox/2026-07-07--lamp-latent-motion-prior-guided-real-world-learning-for-dexterous-hand-manipulation.md): Reports LAMP’s latent motion prior, real-robot task results, and ablations.
