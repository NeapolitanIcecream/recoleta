...
### Evidence
- [AI Agent Pull Requests on GitHub: Frequency, Structure, and Merge Conflict Rates](../Inbox/2026-07-06--ai-agent-pull-requests-on-github-frequency-structure-and-merge-conflict-rates.md): Reports overlap rates for agent-authored pull requests and merge replay conflict rates across AIDev-pop.
- [AI Agent Pull Requests on GitHub: Frequency, Structure, and Merge Conflict Rates](../Inbox/2026-07-06--ai-agent-pull-requests-on-github-frequency-structure-and-merge-conflict-rates.md): States the sampled merge replay result and that most conflicts were source-code changes.
- [From Conversation to Contribution: Characterizing Coding Agent in Open-Source Software](../Inbox/2026-07-06--from-conversation-to-contribution-characterizing-coding-agent-in-open-source-software.md): Shows maintainers perceive other people’s AI-generated code as harder to maintain, even without broad deterioration in observable repository signals.
...
### Evidence
- [Agent Data Injection Attacks are Realistic Threats to AI Agents](../Inbox/2026-07-06--agent-data-injection-attacks-are-realistic-threats-to-ai-agents.md): Defines agent data injection, describes spoofed GitHub comments and fake tool responses, and reports attack success rates.
- [Agent Data Injection Attacks are Realistic Threats to AI Agents](../Inbox/2026-07-06--agent-data-injection-attacks-are-realistic-threats-to-ai-agents.md): Reports remote code execution and supply-chain attack paths on coding agents and identifies missing isolation between trusted and untrusted data.
- [Agent Data Injection Attacks are Realistic Threats to AI Agents](../Inbox/2026-07-06--agent-data-injection-attacks-are-realistic-threats-to-ai-agents.md): Explains the difference between trusted metadata and untrusted content in agent inputs.
...
### Evidence
- [KAT-Coder-V2.5 Technical Report](../Inbox/2026-07-06--kat-coder-v2-5-technical-report.md): Describes executable environment construction, trajectory filtering, and reported AutoBuilder success gains.
- [EdgeBench: Unveiling Scaling Laws of Learning from Real-World Environments](../Inbox/2026-07-06--edgebench-unveiling-scaling-laws-of-learning-from-real-world-environments.md): Describes 12-hour executable tasks, progress curves, and long-run agent evaluation design.
- [EvoAgentBench: Benchmarking Agent Self-Evolution via Ability Transfer](../Inbox/2026-07-06--evoagentbench-benchmarking-agent-self-evolution-via-ability-transfer.md): Describes procedure-transfer testing through Ability units and reports mixed automatic transfer with negative-transfer cases.
